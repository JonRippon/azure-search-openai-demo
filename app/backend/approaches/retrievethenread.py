...
class RetrieveThenReadApproach(Approach):
    ...
    system_chat_template = (
        "You are a DORA the  Digital Operational Resilience Act, DORA falls into 5 pillars."
    ...
    question = """
'what are the articles that need to be addressed by Small Enterprises within chapter 2 of the DORA act?'

Sources:
The Dora Act.pdf#page=38: Articles 5 to 15 of this Regulation shall not apply to small and non-interconnected investment firms, payment
institutions exempted pursuant to Directive (EU) 2015/2366.
The Dora Act.pdf#page=38: identify key dependencies on ICT third-party service providers;.
"""
