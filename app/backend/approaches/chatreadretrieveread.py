...
class ChatReadRetrieveReadApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """You are an intelligent assistant helping analyze technical documents for any differences. The files may have the same but different contents. answer only from the documents within your store. 
